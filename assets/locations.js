    ...
    value: function toggleSticky() {
      ...
      window.addEventListener("scroll", function () {
        setTimeout(function () {
          ...
          if (scrollPosition >= _this2.locationFinder.parentNode.offsetTop) {
            _this2.locationFinder.classList.add("is-sticky");
          } else {
            _this2.locationFinder.classList.remove("is-sticky");
          }
        }, 100);
      });
    }
