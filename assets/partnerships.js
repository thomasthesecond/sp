...
var SubNavigation = function () {
  _createClass(SubNavigation, null, [{
...
var _partnerships = __webpack_require__(141);
...
var _partnerships = __webpack_require__(142);
...
var HomePage = function () {
  ...
  _createClass(HomePage, [{
    ...
    value: function animate() {
      ...
      new _scrollmagic2.default.Scene({ triggerElement: ".js-sub-navigation" }).setClassToggle(".SubNavigation", this.className).addTo(this.controller);
      ...
      new _scrollmagic2.default.Scene({ triggerElement: ".js-physician-practices", offset: 500 }).setClassToggle(".ImageBlock#physician-practices", this.className).addTo(this.controller);

      new _scrollmagic2.default.Scene({ triggerElement: ".js-ambulatory-surgery-centers", offset: 500 }).setClassToggle(".ImageBlock#ambulatory-surgery-centers", this.className).addTo(this.controller);

      new _scrollmagic2.default.Scene({ triggerElement: ".js-surgical-hospitals", offset: 500 }).setClassToggle(".ImageBlock#surgical-hospitals", this.className).addTo(this.controller);

      new _scrollmagic2.default.Scene({ triggerElement: ".js-healthcare-systems", offset: 500 }).setClassToggle(".ImageBlock#healthcare-systems", this.className).addTo(this.controller);

      new _scrollmagic2.default.Scene({ triggerElement: ".js-feature", offset: 500 }).setClassToggle(".Feature .CoverPhoto", this.className).addTo(this.controller);

      new _scrollmagic2.default.Scene({ triggerElement: ".js-feature", offset: 500 }).setClassToggle(".Feature .Testimonial", this.className).addTo(this.controller);

      new _scrollmagic2.default.Scene({ triggerElement: ".js-testimonial-1", offset: 500 }).setClassToggle(".js-testimonial-1", this.className).addTo(this.controller);

      new _scrollmagic2.default.Scene({ triggerElement: ".js-testimonial-2", offset: 500 }).setClassToggle(".js-testimonial-2", this.className).addTo(this.controller);

      new _scrollmagic2.default.Scene({ triggerElement: ".js-testimonial-3", offset: 500 }).setClassToggle(".js-testimonial-3", this.className).addTo(this.controller);

      new _scrollmagic2.default.Scene({ triggerElement: ".js-testimonial-4", offset: 500 }).setClassToggle(".js-testimonial-4", this.className).addTo(this.controller);
    }
  }, {
    key: "render",
    value: function render() {
