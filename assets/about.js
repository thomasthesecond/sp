...
var AboutPage = function () {
  ...
  _createClass(AboutPage, [{
    ...
    value: function animate() {
      ...
      new _scrollmagic2.default.Scene({ triggerElement: ".js-service-cards", offset: -250 }).setClassToggle(".ServiceCards", this.className).addTo(this.controller);
      ...
      new _scrollmagic2.default.Scene({ triggerElement: ".js-feature" }).setClassToggle(".Feature .Highlight", this.className).addTo(this.controller);

      new _scrollmagic2.default.Scene({ triggerElement: ".js-leadership-team", offset: -250 }).setClassToggle(".LeadershipTeam", this.className).addTo(this.controller);
    }
  }, {
    key: "render",
    value: function render() {
